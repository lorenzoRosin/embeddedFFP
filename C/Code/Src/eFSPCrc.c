 ...
 *   GLOBAL FUNCTIONS
 **********************************************************************************************************************/
e_eFSP_Res crc32(const uint8_t data[], const uint32_t dataLen, uint32_t* const crc32Val)
{
	return crc32Seed(ECU_CRC_BASE_SEED, data, dataLen, crc32Val);
}

e_eFSP_Res crc32Seed(const uint32_t seed, const uint8_t dataS[], const uint32_t dataSLen, uint32_t* const crc32SVal)
{
	/* Local variable */
	e_eFSP_Res result;
	uint32_t len;
