 ...
 **********************************************************************************************************************/
static bool_t isPackStatusStillCoherent(const s_eFSP_DataPackCtx* ctx);
 ...
 *   GLOBAL FUNCTIONS
 **********************************************************************************************************************/
e_eFSP_Res dataPackinitCtx(s_eFSP_DataPackCtx* const ctx, uint8_t* const memPKA, const uint32_t memPKASize,
					   const bool_t isLEnd)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackReset(s_eFSP_DataPackCtx* const ctx)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackGetNPushed(s_eFSP_DataPackCtx* const ctx, uint32_t* const retrivedLen)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackPushArray(s_eFSP_DataPackCtx* const ctx, const uint8_t* data, const uint32_t dataLen)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackPushU8(s_eFSP_DataPackCtx* const ctx, const uint8_t dataToPush)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackPushU16(s_eFSP_DataPackCtx* const ctx, const uint16_t dataToPush)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackPushU32(s_eFSP_DataPackCtx* const ctx, const uint32_t dataToPush)
{
	/* Local variable */
	e_eFSP_Res result;
...
e_eFSP_Res dataPackPushU64(s_eFSP_DataPackCtx* const ctx, const uint64_t dataToPush)
{
	/* Local variable */
	e_eFSP_Res result;
 ...
 *  PRIVATE FUNCTION
 **********************************************************************************************************************/
bool_t isPackStatusStillCoherent(const s_eFSP_DataPackCtx* ctx)
{
    bool_t result;
