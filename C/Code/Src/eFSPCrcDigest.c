 ...
 **********************************************************************************************************************/
static bool_t isCrctatusStillCoherent(const s_eFSP_CrcDigestCtx* ctx);
 ...
 *  PRIVATE FUNCTION
 **********************************************************************************************************************/
bool_t isCrctatusStillCoherent(const s_eFSP_CrcDigestCtx* ctx)
{
    bool_t result;
