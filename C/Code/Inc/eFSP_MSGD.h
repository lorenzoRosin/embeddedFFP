 ...
 *		        e_eFSP_MSGD_RES_MESSAGEENDED  	- Frame ended, restart context in order to parse a new frame. Every other call
 ...
 *                                        In this situation bear in mind that some data could be left out the parsing,
 *                                        and so we need to reparse that data after calling MSGD_StartNewMsg.
 *              e_eFSP_MSGD_RES_FRAMERESTART   - During frame receiving another start of frame is received. In this situation
